...
- Python 코드만 작성하면 SQL 문을 알아서 작성해준다.
  ...
  - Migration 파일 (=설계도) 생성
    ...
    ![1572396093201](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572396093201.png)

    <br>

    - 생성 후 프로젝트 구조 

      ![1572396229815](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572396229815.png)
  ...
  - 설계한 Python 코드를 SQL문으로 확인하기
    ...
    - sqlmigrate
      ...
      - 실행화면
        ...
        ![1572396607971](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572396607971.png)
  ...
  - migration 설계도가 실제 DB에 반영되었는지 확인하기
    ...
    - showmigrations
      ...
      - 실행 화면
        ...
        ![1572396709397](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572396709397.png)
...
- 설계도를 실제 DB에 반영한다.
  ...
  - 실행 화면
    ...
    ![1572396888802](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572396888802.png)
...
- 반영된 내역 확인
  ...
  - 실행 화면
    ...
    ![1572397715384](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572397715384.png)
...
- 속성이 바뀌면 설계도를 위의 과정을 다시 
  ...
  - 새로운 설계도 만들기
    ...
    ![1572397950794](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572397950794.png)

    <br>

    - 실행 화면

      ![1572397994361](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572397994361.png)
  ...
  - 새로 작성한 설계도 반영하기
    ...
    - 실행 화면
      ...
      ![1572398047833](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572398047833.png)
  ...
  - 새로 작성한 설계도 반영 확인하기
    ...
    - 실행 화면
      ...
      ![1572398088413](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572398088413.png)
...
- 객체를 표시하는 형식을 사용자 맞춤형으로 커스터마이징 한다.
  ...
  - ipython shell 수행 
    ...
    - 실행 화면 
      ...
      ![1572401482010](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572401482010.png)
...
- sqlite 설치
  ...
  ![1572398351789](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572398351789.png)
...
- sqlite (데이터 베이스) 보러가기
  ...
  - `Ctrl + Shift + p`를 눌러 sqlite 데이터 베이스를 Open할 프로젝트를 선택한다.
    ...
    - `Ctrl + Shift + p`
      ...
      ![1572423517205](../AppData/Roaming/Typora/typora-user-images/1572423517205.png)

      <br>

    - 프로젝트 선택

      ![1572423541317](../AppData/Roaming/Typora/typora-user-images/1572423541317.png)

      <br>

    - 실행 결과 아래와 같이 `SQLITE EXPLORER` 메뉴 탭이 생성된다. 

      ![1572423670006](../AppData/Roaming/Typora/typora-user-images/1572423670006.png)
    ...
    -  `SQLITE EXPLORER`  메뉴를 열어 재생 버튼을 누르면, Model을 토대로 생성된 데이터베이스를 확인할 수 있다.
      ...
      - 구조 
        ...
        ![1572423750842](../AppData/Roaming/Typora/typora-user-images/1572423750842.png)

        <br>

      - 데이터 베이스 확인

        ![1572423797015](../AppData/Roaming/Typora/typora-user-images/1572423797015.png)
...
- ipython 설치
  ...
  - 설치 확인
    ...
    ![1572398657752](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572398657752.png)

    <br>

    - `pip list`

      ![1572398707931](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572398707931.png)
...
- django 안의 manage.py 에 들어가서 shell을 실행한다.
  ...
  - 실행 화면
    ...
    ![1572398790631](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572398790631.png)
...
- Articles 모델을 가져온다.
  ...
  - 실행 화면
    ...
    ![1572398873520](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572398873520.png)
...
- 결과 화면
  ...
  ![1572399616834](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572399616834.png)
...
- 반드시 filter를 사용한다.
  ...
  - 복수형을 return 하는 에러를 뿜는다.
    ...
    ![1572401798568](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572401798568.png)
...
- update
  ...
  - 변경 전
    ...
    ![1572402443349](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572402443349.png)

    <br>

  - 변경 후

    ![1572402477924](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572402477924.png)
...
- delete
  ...
  - 삭제 후
    ...
    ![1572402897725](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572402897725.png)
...
- 생성 코드
  ...
  - 관리자 계정을 생성해서 위의 URL에서 로그인
    ...
    ![1572408787524](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572408787524.png)

    <br>

  - 로그인 페이지

    ![1572408892814](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572408892814.png)

    <br>

  - 로그인 후 admin 페이지![1572408940274](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572408940274.png)
...
- `admin.site.register(Article)`
  ...
  - 위의 코드를 작성한 뒤, admin  페이지를 새로고침
    ...
    ![1572408978961](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572408978961.png)
...
- 객체를 등록 할 때 Django에 원하는 옵션을 알린다.
  ...
  - ModelAdmin 커스터 마이징 하기
    ...
    - 실행 화면 
      ...
      ![1572409568698](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572409568698.png)
...
- filter 옵션
  ...
  - `list_filter = ( [컬럼] , )`
    ...
    - created_at으로 filter
      ...
      - 실행 화면
        ...
        ![1572409820294](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572409820294.png)
    ...
    - title로 filter
      ...
      - 실행 화면
        ...
        ![1572409933214](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572409933214.png)
    ...
    - created_attitle로 filter
      ...
      - 실행 화면
        ...
        ![1572434812134](../AppData/Roaming/Typora/typora-user-images/1572434812134.png)
  ...
  - 링크 설정
    ...
    - 실행 화면
      ...
      ![1572434761441](../AppData/Roaming/Typora/typora-user-images/1572434761441.png)
  ...
  - list에서 바로 수정 가능 하도록
    ...
    - list_editable
      ...
      - 실행 화면
        ...
        ![1572434775802](../AppData/Roaming/Typora/typora-user-images/1572434775802.png)
  ...
  - 한 페이지에 list 몇개?
    ...
    - `list_per_page`
      ...
      - 실행 화면
        ...
        ![1572434787871](../AppData/Roaming/Typora/typora-user-images/1572434787871.png)
...
![1572411796927](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572411796927.png)
...
- Application 등록하기
  ...
  - config/ setting.py
    ...
    ![1572434887463](../AppData/Roaming/Typora/typora-user-images/1572434887463.png)
...
- Django Shell 실행하기
  ...
  - 실행 화면
    ...
    ![1572412073795](C:\Users\student\AppData\Roaming\Typora\typora-user-images\1572412073795.png)
