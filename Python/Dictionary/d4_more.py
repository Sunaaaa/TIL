...
False
"""
# m_list = t4ir.get('language').get('python').get('python standard library')
# print(m_list)
...
매니저
"""
my_list = t4ir.get('classes').get('bigdata')
print(my_list)
...
"""
my_list = t4ir.get('language').get('python').get('frameworks')
...
my_list = t4ir.get('classes').get('connected').get('groups').get('E')
dangbeon = random.choice(my_list)
print(f'오늘의 당번은 {dangbeon}')
